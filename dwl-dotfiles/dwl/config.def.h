...
static uint32_t colors[][3]                = {
   /*               fg          bg          border    */
   [SchemeNorm] = { 0xc0caf5ff, 0x000000ff, 0x24283bff },
   [SchemeSel]  = { 0x7aa2f7ff, 0x000000ff, 0x7aa2f7ff }, 
   [SchemeUrg]  = { 0xf7768eff, 0x000000ff, 0xf7768eff },
};
...
static const char *const autostart[] = {
        "swaybg", "-i", "/home/zen/Pictures/Wallpapers/mainwall3.png", NULL,
        NULL /* terminate */
};
...
static const char *screenshot_full[]  = { "sh", "-c", "grim ~/Pictures/Screenshots/screenshot-$(date +%F-%T).png", NULL };
static const char *screenshot_area[]  = { "sh", "-c", "grim -g \"$(slurp)\" - | wl-copy -t image/png -f", NULL };
...
static const Key keys[] = {
        ...
        { MODKEY,                                       XKB_KEY_a,                setlayout,          {.v = &layouts[1]} },
        { MODKEY,                                       XKB_KEY_m,                setlayout,          {.v = &layouts[2]} },

        { MODKEY,                                       XKB_KEY_space,            setlayout,          {0} },
        { MODKEY|WLR_MODIFIER_SHIFT,                    XKB_KEY_space,            togglefloating,     {0} },
        { MODKEY,                                       XKB_KEY_e,                togglefullscreen,   {0} },
        // { MODKEY,                                       XKB_KEY_f,                togglefullscreenadaptivesync,   {0} },
    ...
    /* Ctrl-Alt-Fx switches to another VT */
